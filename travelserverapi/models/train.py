...
class Train(ItineraryItem):
    ...
    departure_station_address = models.ForeignKey(Address, related_name="departure", on_delete=models.SET_NULL, null=True)
    departure_time = models.TimeField()
    arrival_station = models.CharField(max_length=100)
    arrival_station_address = models.ForeignKey(Address, related_name="arrival", on_delete=models.SET_NULL, null=True)
